...
class Scoreboard:
    """Uma classe para mostrar informações de pontuação."""
    ...
    def __init__(self, ai_game):
        ...
        # Prepara as imagens de pontuação inicial
        self.prep_score()
    ...
    def prep_score(self):
        ...
        # Mostra a pontuação no canto superior direito da tela
    ...
    def show_score(self):
        """Desenha as pontuações, nível e naves restantes na tela."""
